...
export const PROJECTS = [
  {
    ...
    tags:     ['React.js', 'Spring Boot', 'PostgreSQL', 'Docker', 'JWT', 'Tailwind CSS'],
    ...
    skeleton: {
      nodes: [
        { id: 'react',    label: 'React.js',    x: 20,  y: 90,  color: '#61DAFB', w: 80 },
        { id: 'tailwind', label: 'Tailwind',    x: 20,  y: 135, color: '#38BDF8', w: 80 },
        { id: 'spring',   label: 'Spring Boot', x: 145, y: 90,  color: '#6DB33F', w: 90 },
        { id: 'jwt',      label: 'JWT+RBAC',    x: 145, y: 135, color: '#F59E0B', w: 90 },
        { id: 'postgres', label: 'PostgreSQL',  x: 280, y: 90,  color: '#336791', w: 85 },
        { id: 'docker',   label: 'Docker',      x: 280, y: 135, color: '#2496ED', w: 85 },
      ],
      edges: [
  ...
  },
  {
    ...
    skeleton: {
      nodes: [
        ...
        { id: 'ir',       label: 'IR Sensor',  x: 20,  y: 170, color: '#9B59B6', w: 72 },
        { id: 'firebase', label: 'Firebase',   x: 155, y: 120, color: '#FFCA28', w: 80 },
        { id: 'python',   label: 'Python API', x: 290, y: 95,  color: '#3776AB', w: 80 },
        { id: 'nextjs',   label: 'Next.js UI', x: 290, y: 143, color: '#EEEEEE', w: 80 },
      ],
      edges: [
  ...
  },
  {
    ...
    skeleton: {
      nodes: [
        { id: 'react',   label: 'React UI',    x: 20,  y: 110, color: '#61DAFB', w: 82 },
        { id: 'spring',  label: 'Spring Boot', x: 155, y: 110, color: '#6DB33F', w: 88 },
        { id: 'mysql',   label: 'MySQL',       x: 300, y: 110, color: '#4479A1', w: 72 },
        { id: 'jwt',     label: 'JWT Auth',    x: 155, y: 158, color: '#F59E0B', w: 88 },
      ],
      edges: [
        { from: 'react',  to: 'spring' },
  ...
  },
  {
    ...
    skeleton: {
      nodes: [
        ...
        { id: 'firebase', label: 'Firebase',   x: 155, y: 122, color: '#FFCA28', w: 80 },
        { id: 'react',    label: 'React Dash', x: 295, y: 122, color: '#61DAFB', w: 82 },
      ],
      edges: [
        { from: 'esp32',    to: 'firebase' },
        { from: 'dht',      to: 'firebase' },
...
export const FOOTBALL = {
  ...
  quote:     '"Football is like code — it\'s all about the right passes at the right time."',
  stats: {
    'Matches Played': '200+',
