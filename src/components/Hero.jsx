      ...
      <AnimatePresence>
        {showQuote && (
          <motion.div
            ...
            className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 p-2.5 rounded-lg text-center pointer-events-none"
            style={{
          ...
          >
            <p className="text-[10px] font-mono text-theme-muted leading-relaxed">
              "Football is like code — it's all about the right passes at the right time."
            </p>
            <div
              className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 rotate-45 -mt-1"
              style={{ background: 'var(--color-bg-card)', borderBottom: '1px solid var(--color-border)', borderRight: '1px solid var(--color-border)' }}
            />
          </motion.div>
        )}
      </AnimatePresence>
...
export default function Hero() {
  ...
  const tickerItems = isHardware
    ? ['ESP32', 'IoT Systems', 'DHT11', 'Firebase', 'Next.js', 'Python', 'C', 'MatLab', 'Embedded Systems']
    : ['React.js', 'Spring Boot', 'Next.js', 'PostgreSQL', 'Docker', 'JWT Auth', 'MySQL', 'Tailwind CSS'];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: isHardware ? 2 : 5, repeat: Infinity, ease: 'easeInOut' }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex-1 h-px max-w-16" style={{ background: 'var(--color-border)' }} />
            <FootballEasterEgg />
          </motion.div>
      ...
      >
        <span className="font-mono text-[9px] tracking-[0.25em] text-theme-faint">SCROLL</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
